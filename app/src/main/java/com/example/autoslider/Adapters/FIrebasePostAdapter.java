...
public class FIrebasePostAdapter extends FirebaseRecyclerAdapter<ModelPost,FIrebasePostAdapter.holder> {
    Context context;
    ArrayList<IdModel> bookmarkList;

    public FIrebasePostAdapter(@NonNull FirebaseRecyclerOptions<ModelPost> options, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull holder holder, int position, @NonNull ModelPost model) {
