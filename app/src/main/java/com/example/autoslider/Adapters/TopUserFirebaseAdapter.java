...
public class TopUserFirebaseAdapter extends FirebaseRecyclerAdapter<ModelUserReal,TopUserFirebaseAdapter.holder> {
    ArrayList<FriendsModel> friendsList;
    Context context;
    public TopUserFirebaseAdapter(@NonNull FirebaseRecyclerOptions<ModelUserReal> options, Context context) {
        super(options);
